...
from src.api import ApiCompany, ApiLabels, ApiOrders, ApiShipments, ApiServices, ApiTracking
...
class FxCouriersIntegration:
    ...
    async def get_company(
        self, credentials: FxCouriersCredentials, company_id: int,
    ) -> tuple[dict, int]:
    ...
    async def get_order(
        self, credentials: FxCouriersCredentials, order_id: int,
    ) -> tuple[dict, int]:
    ...
    async def find_order_by_number(
        self, credentials: FxCouriersCredentials, order_number: str,
    ) -> tuple[dict, int]:
