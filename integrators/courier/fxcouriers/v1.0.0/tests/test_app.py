...
def test_get_services(mock_integration):
    mock_integration.get_services = AsyncMock(
        return_value=(
...
def test_get_company(mock_integration):
    mock_integration.get_company = AsyncMock(
        return_value=(
...
def test_get_orders(mock_integration):
    mock_integration.get_orders = AsyncMock(
        return_value=(
...
def test_get_label(mock_integration):
    mock_integration.get_label = AsyncMock(
        return_value=(
...
def test_get_pickup(mock_integration):
    mock_integration.get_shipment = AsyncMock(
        return_value=(
...
def test_cancel_pickup(mock_integration):
    mock_integration.cancel_shipment = AsyncMock(
        return_value=(
