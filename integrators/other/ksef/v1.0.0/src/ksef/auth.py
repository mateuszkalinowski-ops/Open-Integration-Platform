...
class AuthSession:
    ...
    access_token: str = ""
    refresh_token: str = ""
    access_valid_until: datetime = field(default_factory=lambda: datetime.min.replace(tzinfo=timezone.utc))
    refresh_valid_until: datetime = field(default_factory=lambda: datetime.min.replace(tzinfo=timezone.utc))
