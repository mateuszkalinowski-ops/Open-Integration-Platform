"""Manages multiple SkanujFakture account configurations loaded from YAML or environment."""
...
class AccountManager:
    """Loads and provides access to SkanujFakture account configurations."""

    def __init__(self) -> None:
        self._accounts: dict[str, SkanujFaktureAccountConfig] = {}
    ...
    def load_from_yaml(self, path: str | None = None) -> None:
        ...
        for account_data in data.get("accounts", []):
            account = SkanujFaktureAccountConfig(**account_data)
    ...
    def _load_from_env(self) -> None:
        ...
        if not self._accounts:
            logger.warning("No SkanujFakture accounts configured")

    def get_account(self, name: str) -> SkanujFaktureAccountConfig | None:
        return self._accounts.get(name)

    def list_accounts(self) -> list[SkanujFaktureAccountConfig]:
