...
async def list_documents(  # noqa: PLR0913
    ...
    company_entity_id: int | None = Query(None),
    company_entity_ids: list[int] | None = Query(None),
    company_entity_nips: list[str] | None = Query(None),
    is_sale: bool | None = Query(None),
    invoice: list[str] | None = Query(None),
    contractor: list[str] | None = Query(None),
    contractor_nips: list[str] | None = Query(None),
    real_contractor: list[str] | None = Query(None),
    real_contractor_nips: list[str] | None = Query(None),
    receiver: list[str] | None = Query(None),
    receiver_nips: list[str] | None = Query(None),
    buyer: list[str] | None = Query(None),
    buyer_nips: list[str] | None = Query(None),
    edit_user: list[str] | None = Query(None),
    number: list[str] | None = Query(None),
    document_types: list[int] | None = Query(None),
    payment_types: list[int] | None = Query(None),
    acceptance_status: list[str] | None = Query(None),
    category: list[str] | None = Query(None),
    text: list[str] | None = Query(None),
    vat_costs: list[str] | None = Query(None),
    cost_types: list[str] | None = Query(None),
    cost_centers: list[str] | None = Query(None),
    decret_attributes: list[str] | None = Query(None),
    decret_attributes2: list[str] | None = Query(None),
    decret_attributes3: list[str] | None = Query(None),
    decret_attributes4: list[str] | None = Query(None),
    decret_attributes5: list[str] | None = Query(None),
    decret_attributes6: list[str] | None = Query(None),
    decret_attributes7: list[str] | None = Query(None),
    decret_attributes8: list[str] | None = Query(None),
    descriptions: list[str] | None = Query(None),
    filenames: list[str] | None = Query(None),
    account_numbers: list[str] | None = Query(None),
    ksef_number: list[str] | None = Query(None),
    company_entity_id_where_users_are_guests: list[int] | None = Query(None),
    create_date_from: int | None = Query(None),
    create_date_to: int | None = Query(None),
    date_from: str | None = Query(None),
    date_to: str | None = Query(None),
    operation_date_from: str | None = Query(None),
    operation_date_to: str | None = Query(None),
    posting_date_from: str | None = Query(None),
    posting_date_to: str | None = Query(None),
    input_date_from: str | None = Query(None),
    input_date_to: str | None = Query(None),
    payment_date_from: str | None = Query(None),
    payment_date_to: str | None = Query(None),
    netto_from: float | None = Query(None),
    netto_to: float | None = Query(None),
    vat_from: float | None = Query(None),
    vat_to: float | None = Query(None),
    brutto_from: float | None = Query(None),
    brutto_to: float | None = Query(None),
    amount_to_pay_from: float | None = Query(None),
    amount_to_pay_to: float | None = Query(None),
    duplicate: int | None = Query(None),
    decreted: bool | None = Query(None),
    archive: bool | None = Query(None),
    in_ksef: bool | None = Query(None),
    payment_status: str | None = Query(None),
    comment: str | None = Query(None),
    check_document_ids: list[int] | None = Query(None),
    exception_check_document_ids: list[int] | None = Query(None),
) -> list[dict[str, Any]]:
    _require_account(account_name)
    try:
