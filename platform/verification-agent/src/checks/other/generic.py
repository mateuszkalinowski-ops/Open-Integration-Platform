"""Tier 3 functional checks — Generic fallback for "other" category connectors.

Tests account listing and connector-specific read-only endpoints
for connectors without a dedicated test module.
"""
