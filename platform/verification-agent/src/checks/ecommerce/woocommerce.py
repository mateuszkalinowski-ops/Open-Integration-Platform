...
async def run(
    ...
    chk, _ = await req_check(
        client, "GET", f"{base}/connection/{account}/status", "connection_status",
    )
    results.append(chk)
    ...
    if order_id:
        results.append(await get_check(
            client, f"{base}/orders/{order_id}", "get_order",
            params=p,
        ))
        results.append(await get_check(
            client, f"{base}/orders/{order_id}/notes", "list_order_notes",
            params=p,
        ))
        results.append(await get_check(
            client, f"{base}/orders/{order_id}/refunds", "list_order_refunds",
            params=p,
        ))
    else:
    ...
    chk, _ = await req_check(
        client, "PUT", f"{base}/orders/99999999/status", "update_order_status_dummy",
    ...
    if product_id:
        results.append(await get_check(
            client, f"{base}/products/{product_id}", "get_product",
            params=p,
        ))
        results.append(await get_check(
            client, f"{base}/products/{product_id}/variations", "list_variations",
            params=p,
        ))
    else:
    ...
    chk, _ = await req_check(
        client, "GET", f"{base}/products/tags", "list_product_tags",
        params=p,
        accept_statuses=(200, 401),
    )
    results.append(chk)
    ...
    chk, _ = await req_check(
        client, "GET", f"{base}/products/attributes", "list_product_attributes",
        params=p,
        accept_statuses=(200, 401),
    )
    results.append(chk)
    ...
    chk, _ = await req_check(
        client, "GET", f"{base}/products/reviews", "list_product_reviews",
        params=p,
        accept_statuses=(200, 401),
    )
    results.append(chk)
    ...
    chk, _ = await req_check(
        client, "GET", f"{base}/products/shipping_classes", "list_shipping_classes",
        params=p,
        accept_statuses=(200, 401),
    )
    results.append(chk)
    ...
    if customer_id:
        results.append(await get_check(
            client, f"{base}/customers/{customer_id}", "get_customer",
            params=p,
        ))
        results.append(await get_check(
            client, f"{base}/customers/{customer_id}/downloads", "list_customer_downloads",
            params=p,
        ))
    else:
    ...
    chk, _ = await req_check(
        client, "GET", f"{base}/coupons", "list_coupons",
        params=p,
        accept_statuses=(200, 401),
    )
    results.append(chk)
    ...
    chk, _ = await req_check(
        client, "GET", f"{base}/taxes", "list_tax_rates",
        params=p,
        accept_statuses=(200, 401),
    )
    results.append(chk)
    ...
    chk, _ = await req_check(
        client, "GET", f"{base}/taxes/classes", "list_tax_classes",
        params=p,
        accept_statuses=(200, 401),
    )
    results.append(chk)
    ...
    chk, _ = await req_check(
        client, "GET", f"{base}/reports", "list_reports",
        params=p,
        accept_statuses=(200, 401),
    )
    results.append(chk)
    ...
    chk, _ = await req_check(
        client, "GET", f"{base}/reports/sales", "sales_report",
        params=p,
        accept_statuses=(200, 401),
    )
    results.append(chk)
    ...
    chk, _ = await req_check(
        client, "GET", f"{base}/reports/top_sellers", "top_sellers_report",
        params=p,
        accept_statuses=(200, 401),
    )
    results.append(chk)
    ...
    chk, _ = await req_check(
        client, "GET", f"{base}/reports/orders/totals", "orders_totals",
        params=p,
        accept_statuses=(200, 401),
    )
    results.append(chk)
    ...
    chk, _ = await req_check(
        client, "GET", f"{base}/reports/products/totals", "products_totals",
        params=p,
        accept_statuses=(200, 401),
    )
    results.append(chk)
    ...
    chk, _ = await req_check(
        client, "GET", f"{base}/webhooks", "list_webhooks",
        params=p,
        accept_statuses=(200, 401),
    )
    results.append(chk)
    ...
    chk, _ = await req_check(
        client, "GET", f"{base}/settings", "list_settings_groups",
        params=p,
        accept_statuses=(200, 401),
    )
    results.append(chk)
    ...
    chk, _ = await req_check(
        client, "GET", f"{base}/payment_gateways", "list_payment_gateways",
        params=p,
        accept_statuses=(200, 401),
    )
    results.append(chk)
    ...
    chk, _ = await req_check(
        client, "GET", f"{base}/shipping/zones", "list_shipping_zones",
        params=p,
        accept_statuses=(200, 401),
    )
    results.append(chk)
    ...
    chk, _ = await req_check(
        client, "GET", f"{base}/shipping_methods", "list_shipping_methods",
        params=p,
        accept_statuses=(200, 401),
    )
    results.append(chk)
    ...
    chk, _ = await req_check(
        client, "GET", f"{base}/system_status", "get_system_status",
        params=p,
        accept_statuses=(200, 401),
    )
    results.append(chk)
    ...
    chk, _ = await req_check(
        client, "GET", f"{base}/system_status/tools", "list_system_status_tools",
        params=p,
        accept_statuses=(200, 401),
    )
    results.append(chk)
    ...
    chk, _ = await req_check(
        client, "POST", f"{base}/stock/sync", "stock_sync_dummy",
