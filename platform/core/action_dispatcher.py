...
_ACTION_ROUTES: dict[str, dict[str, ActionRoute]] = {
    ...
    "allegro": {
        ...
        "order.invoice_upload": ActionRoute(method="POST", path="/orders/{order_id}/invoice", query_from_payload=["account_name"]),
        "order.invoices_get": ActionRoute(method="GET", path="/orders/{order_id}/invoices", query_from_payload=["account_name"]),
